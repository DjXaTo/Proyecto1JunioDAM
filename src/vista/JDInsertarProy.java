 ...
 * @author Jairo
 */
public class JDInsertarProy extends javax.swing.JDialog {

    /**
     * Creates new form JDInsertProy
     */
    public JDInsertarProy(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDInsertarProy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDInsertarProy dialog = new JDInsertarProy(new javax.swing.JFrame(), true);
